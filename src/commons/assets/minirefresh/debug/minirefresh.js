...
var Core = function () {
    ...
    function Core(options) {
        ...
        this.container = isString(this.options.container) ?  selector(this.options.container) : this.options.container;
...
var MiniRefreshTheme = function (_Core) {
    ...
    _createClass(MiniRefreshTheme, [{
        ...
        value: function _initDownWrap() {
            ...
            var svgIcon = [
                '<div class="downwrap-progress">',
                '<svg viewBox="0 0 63.657 63.657" style="enable-background:new 0 0 63.657 63.657;" xml:space="preserve" width="20px" height="20px">',
                ...
                '</svg>',
                '</div>',
                '<div class="'+CLASS_HIDDEN+'"><img src="/static/images/newshop/pul.gif" alt="" style="height:0.3rem;width:0.2rem;" ></div>'
            ];
        ...
        value: function _initUpWrap() {
            ...
            var _loaddingBox = [
                '<div class="loadingBox upwrap-progress">',
                    '<span></span>',
                    '<span></span>',
                    '<span></span>',
                    '<span></span>',
        ...
        value: function _pullHook(downHight, downOffset) {
            ...
            if (downHight < downOffset) {
                ...
                this.downWrapProgress && this.downWrapProgress.classList.add('active');
        ...
        value: function _downLoaingHook() {
            ...
            this.downWrapTips.innerText = '';
            let _imgDiv = this.downWrapProgress.nextElementSibling;
            this.downWrapProgress.classList.add(CLASS_HIDDEN);
            _imgDiv.classList.remove(CLASS_HIDDEN);
        ...
        value: function _downLoaingSuccessHook(isSuccess, successTips) {
            ...
            this.downWrapProgress.classList.remove('active');
            // this.downWrapProgress.classList.remove('hide');
            // let _imgDiv = this.downWrapProgress.nextElementSibling;
            // _imgDiv.classList.add('hide');
        ...
        value: function _downLoaingEndHook(isSuccess) {
            ...
            setTimeout(()=>{
                ...
                let _imgDiv = this.downWrapProgress.nextElementSibling;
                _imgDiv.classList.add(CLASS_HIDDEN);
